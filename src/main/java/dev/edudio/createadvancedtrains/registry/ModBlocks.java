...
public final class ModBlocks {
    ...
    public static final RegistryObject<Block> STAINLESS_STEEL_BODY = BLOCKS.register(
            "stainless_steel_body",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.ANDESITE)
                    .mapColor(MapColor.TERRACOTTA_CYAN)
                    .sound(SoundType.NETHERITE_BLOCK)));

    public static final RegistryObject<Item> STAINLESS_STEEL_BODY_ITEM = ITEMS.register(
            "stainless_steel_body",
            () -> new BlockItem(STAINLESS_STEEL_BODY.get(), new Item.Properties()));
